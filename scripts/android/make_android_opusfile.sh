...
function make_opusfile() {
	...
	$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/linux-x86_64/bin/$3$4-clang -v -c -I${PWD}/../include -I${PWD}/include -Dftello=ftell -Dfseek=fseek ../src/opusfile.c ../src/info.c ../src/stream.c ../src/internal.c
	$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar rvs libopusfile.a opusfile.o info.o stream.o internal.o
	cd ..
}
