...
__TW_KEY_NAME=$(echo ${TW_KEY_NAME}|sed 's/\//\\\//g')
__TW_KEY_PW=$(echo ${TW_KEY_PW}|sed 's/\//\\\//g')
__TW_KEY_ALIAS=$(echo ${TW_KEY_ALIAS}|sed 's/\//\\\//g')

sed -i "s/TW_KEY_NAME/${__TW_KEY_NAME}/g" build.gradle
sed -i "s/TW_KEY_PW/${__TW_KEY_PW}/g" build.gradle
sed -i "s/TW_KEY_ALIAS/${__TW_KEY_ALIAS}/g" build.gradle
...
__TW_HOME_DIR=$(echo $(echo ~)|sed 's/\//\\\//g')
